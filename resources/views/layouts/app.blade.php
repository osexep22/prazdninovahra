...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; } body { margin:0; font-family: system-ui, Segoe UI, sans-serif; color:var(--ink); background:#f5f7ef; }
        ...
        body.is-meadow .side:hover, body.is-meadow .side:focus-within, body.is-meadow .side.force-open, body.is-anthill .side:hover, body.is-anthill .side:focus-within, body.is-anthill .side.force-open { width:min(760px, calc(100vw - 36px)); border-radius:18px; padding:14px; overflow:visible; }
        ...
        .badge-strip-compact { overflow:visible; }
        ...
        body.is-meadow .side:hover .badge-strip-full, body.is-meadow .side:focus-within .badge-strip-full, body.is-meadow .side.force-open .badge-strip-full, body.is-anthill .side:hover .badge-strip-full, body.is-anthill .side:focus-within .badge-strip-full, body.is-anthill .side.force-open .badge-strip-full { display:grid; grid-auto-flow:column; grid-template-rows:repeat(var(--badge-panel-rows, 6), 42px); grid-auto-columns:42px; gap:7px; align-items:center; justify-content:start; max-width:100%; overflow:visible; padding:2px 0 8px; }
