...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; } body { margin:0; font-family: system-ui, Segoe UI, sans-serif; color:var(--ink); background:#f5f7ef; }
        ...
        body.onboarding-menu-focus .top { z-index:960; background:rgba(255,255,255,.98); filter:none; opacity:1; box-shadow:0 0 0 5px rgba(255,212,59,.45), 0 0 0 9999px rgba(15,23,42,.10), 0 16px 34px rgba(70,95,35,.18); animation:onboardingGlow 1.35s ease-in-out infinite; }
        body.onboarding-stats-focus .side { z-index:960; background:#fffaf0; filter:none; opacity:1; box-shadow:0 0 0 5px rgba(255,212,59,.5), 0 0 0 9999px rgba(15,23,42,.10), 0 18px 48px rgba(40,55,29,.24); animation:onboardingGlow 1.35s ease-in-out infinite; }
        ...
        .anthill-board { position:relative; z-index:1; width:min(calc(100vw - 48px), calc((100vh - 172px) * 1)); max-width:1220px; aspect-ratio:1 / 1; align-self:center; justify-self:center; overflow:hidden; border-radius:8px; background-color:#8b6741; background-image:var(--anthill-variant), url('/assets/game/anthill/anthill-background.png'), url('/assets/game/anthill-map-v2.png'); background-position:center, center, center; background-size:100% 100%, 100% 100%, 100% 100%; background-repeat:no-repeat; box-shadow:0 18px 50px rgba(40,25,12,.26); }
